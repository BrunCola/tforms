...
(function($) {
	...
	function createControls(dash) {
		...
		controls.addClass('jdash-controls dropdown-menu hold-on-click dropdown-checkboxes');
...
//	
//		var arr = [];
//		$("#sortable").children().find(".dc-chart").each(function(){
//			var divid = $(this).attr('id');
//			var width = $(this).width();
//			var height = $(this).height();
//			arr.push({"id": divid,"width": width,"height": height});
//		});
//		localStorage.setItem('gSize_'+getURLParameter('type'), JSON.stringify(arr));
