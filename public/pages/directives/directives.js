                        ...
                        switch(nickname){
                            ...
                            case 'email':
                                ...
                                element.append('polygon')
                                    .style('fill', '#58595B')
                                    .attr('points', '18.4,17.1 9.9,11.9 26.8,11.9 ')
                                    .attr('transform', 'translate(-36,-32) scale(1.2)');
                                element.append('polygon')
                                    .style('fill', '#58595B')
                                    .attr('points', '27.8,23.6 8.9,23.6 8.9,12.3 18.4,18.3 27.8,12.3 ')
                                    .attr('transform', 'translate(-36,-32) scale(1.2)');
                            case 'ssl':
                                element.append('circle')
                                    .attr('fill', '#A0BB71')
                                ...
                                element.append('svg:path')
                                    .attr('fill', '#58595B')
                                    .attr('d', 'M9.2,19.7c0.1,0.4,0.2,0.7,0.3,0.9c0.3,0.4,0.8,0.5,1.5,0.5c0.4,0,0.8,0,1.1-0.1'+
                                        'c0.5-0.2,0.8-0.5,0.8-1c0-0.3-0.1-0.5-0.4-0.7c-0.3-0.2-0.7-0.3-1.2-0.4l-0.9-0.2c-0.9-0.2-1.6-0.4-1.9-0.7c-0.6-0.4-0.9-1-0.9-1.9'+
                                        'c0-0.8,0.3-1.4,0.9-1.9s1.4-0.8,2.5-0.8c0.9,0,1.7,0.2,2.4,0.7c0.7,0.5,1,1.2,1,2.1h-1.7c0-0.5-0.3-0.9-0.7-1.1'+
                                        'C11.6,15,11.3,15,10.8,15c-0.5,0-0.9,0.1-1.1,0.3c-0.3,0.2-0.4,0.4-0.4,0.8c0,0.3,0.1,0.5,0.4,0.7c0.2,0.1,0.6,0.2,1.1,0.4l1.5,0.4'+
                                        'c0.7,0.2,1.2,0.4,1.5,0.6c0.5,0.4,0.8,1,0.8,1.8c0,0.8-0.3,1.4-0.9,2s-1.5,0.8-2.6,0.8c-1.1,0-2-0.3-2.7-0.8s-1-1.2-1-2.1H9.2z');
                                element.append('svg:path')
                                    .attr('fill', '#58595B')
                                    .attr('d', 'M17.2,19.7c0.1,0.4,0.2,0.7,0.3,0.9c0.3,0.4,0.8,0.5,1.5,0.5c0.4,0,0.8,0,1.1-0.1'+
                                        'c0.5-0.2,0.8-0.5,0.8-1c0-0.3-0.1-0.5-0.4-0.7c-0.3-0.2-0.7-0.3-1.2-0.4l-0.9-0.2c-0.9-0.2-1.6-0.4-1.9-0.7c-0.6-0.4-0.9-1-0.9-1.9'+
                                        'c0-0.8,0.3-1.4,0.9-1.9s1.4-0.8,2.5-0.8c0.9,0,1.7,0.2,2.4,0.7c0.7,0.5,1,1.2,1,2.1h-1.7c0-0.5-0.3-0.9-0.7-1.1'+
                                        'C19.6,15,19.3,15,18.8,15c-0.5,0-0.9,0.1-1.1,0.3c-0.3,0.2-0.4,0.4-0.4,0.8c0,0.3,0.1,0.5,0.4,0.7c0.2,0.1,0.6,0.2,1.1,0.4l1.5,0.4'+
                                        'c0.7,0.2,1.2,0.4,1.5,0.6c0.5,0.4,0.8,1,0.8,1.8c0,0.8-0.3,1.4-0.9,2c-0.6,0.5-1.5,0.8-2.6,0.8c-1.1,0-2-0.3-2.7-0.8s-1-1.2-1-2.1'+
                                        'H17.2z');
                                element.append('svg:path')
                                    .attr('fill', '#58595B')
                                    .attr('d', 'M23.9,13.7h1.8v7.1H30v1.6h-6.1V13.7z');
                                return;
                            case 'ssl_ioc':
                                element.append('circle')
                                    .attr('fill', '#D97373')
