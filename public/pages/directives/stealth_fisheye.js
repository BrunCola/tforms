...
angular.module('mean.pages').directive('stealthFishGraph', ['$timeout', '$location', '$rootScope', '$http', '$modal', function ($timeout, $location, $rootScope, $http, $modal) {
	return {
		link: function ($scope, element, attrs) {
					...
					switch(nickname){
						...
						case 'login':
							...
							element.append('svg:polygon')
								.attr('transform', 'translate(-18,-18)')
								.attr('fill', '#58595B')
								.attr('points', '12.088,24.273 17.417,24.258 23.896,17.676 17.459,11.227 12.195,11.227 16.001,15.227 '+
									'4.009,15.227 4.009,20.491 15.894,20.4 14.244,22.123 ')
							element.append('svg:polygon')
								.attr('transform', 'translate(-18,-18)')
								.attr('fill', '#58595B')
								.attr('points', '27.238,23.029 27.238,12.818 20.391,12.818 20.391,10.168 29.904,10.168 29.904,25.742 '+
									'20.391,25.742 20.391,23.029 ')
							if(dType === 'legend') {
								element.append('text')
									.text(title)
									.attr('fill', '#7f7f7f')
						...
						case 'logout':
							...
							element.append('svg:polygon')
								.attr('transform', 'translate(-18,-18)')
								.attr('fill', '#58595B')
								.attr('points', '21.567,24.439 26.896,24.424 33.375,17.758 26.938,11.227 21.676,11.227 25.479,16.227 '+
									'13.714,16.227 13.714,20.656 25.485,20.566 23.78,22.289 ')
							element.append('svg:polygon')
								.attr('transform', 'translate(-18,-18)')
								.attr('fill', '#58595B')
								.attr('points', '9.29,23.15 9.29,12.938 20.32,12.938 20.32,10.288 6.624,10.288 6.624,25.862 20.32,25.862 '+
									'20.32,23.15 ')
							if(dType === 'legend') {
								element.append('text')
									.text(title)
			...
			// !D3 FISHEYE PLUGIN
			$scope.$on('fishChartData', function (event, data){
				...
				var pStealthBlocked = $scope.legendHolder.append('g');
				...
				var pLogIn = $scope.legendHolder.append('g');
				var pLogOut = $scope.legendHolder.append('g');
				var legendPoints = [
					{
						element: pEndpoint,
						nickname: 'endpoint',
					...
					{
						element: pStealthBlocked,
						nickname: 'stealthBlocked',
						title: titles('stealthBlocked')
					},
					{
						element: pLogIn,
						nickname: 'login',
