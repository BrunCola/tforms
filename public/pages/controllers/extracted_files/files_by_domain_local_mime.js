...
angular.module('mean.pages').controller('byDomainLocalMimeController', ['$scope', '$stateParams', '$location', 'Global', '$rootScope', '$http', 'runPage', 'Crossfilter', function ($scope, $stateParams, $location, Global, $rootScope, $http, runPage, Crossfilter) {
    $scope.global = Global;
    var query;
    ...
    var page = [
        ...
        /////////////////
        {
            ...
            get: '/api/extracted_files/files_by_domain_local_mime/table',
            run: function(data) {
