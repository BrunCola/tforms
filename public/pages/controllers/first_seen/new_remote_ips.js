...
angular.module('mean.pages').controller('newRemoteIpsController', ['$scope', '$stateParams', '$location', 'Global', '$rootScope', '$http', function ($scope, $stateParams, $location, Global, $rootScope, $http) {
	$scope.global = Global;
	var query;
	if ($location.$$search.start && $location.$$search.end) {
		query = '/first_seen/new_remote_ips?start='+$location.$$search.start+'&end='+$location.$$search.end;
	} else {
		query = '/first_seen/new_remote_ips?';
	}
