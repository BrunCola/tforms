...
angular.module('mean.pages').controller('newRemoteController', ['$scope', '$stateParams', '$location', 'Global', '$rootScope', '$http', 'timeFormat', 'runPage', 'Crossfilter', function ($scope, $stateParams, $location, Global, $rootScope, $http, timeFormat, runPage, Crossfilter) {
    $scope.global = Global;
    var query;
    ...
    var page = [
        ...
        /////////////////
        {
            ...
            get: '/api/first_seen/new_remote/crossfilter', // no get default to main url, strings will replace the default (otherwise /[from root])
            visuals: [
                {
                    type: 'barchart',
                    settings: { 
        ...
        /////////////////
        {
            ...
            refresh: true,
            searchable: true, // optional search param.. no if undefined
            get: '/api/first_seen/new_remote/table',
            run: function(data) {
    ...
    //     query = '/api/first_seen/new_remote?start='+$location.$$search.start+'&end='+$location.$$search.end;
    // } else {
    //     query = '/api/first_seen/new_remote?';
    // }
