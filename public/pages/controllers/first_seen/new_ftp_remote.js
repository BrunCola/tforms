...
angular.module('mean.pages').controller('newFtpRemoteController', ['$scope', '$stateParams', '$location', 'Global', '$rootScope', '$http', 'timeFormat', 'runPage', 'Crossfilter', function ($scope, $stateParams, $location, Global, $rootScope, $http, timeFormat, runPage, Crossfilter) {
    $scope.global = Global;
    var query;
    ...
    var page = [
        ...
        /////////////////
        {
            ...
            get: '/api/first_seen/new_ftp_remote/crossfilter', // no get default to main url, strings will replace the default (otherwise /[from root])
            visuals: [
                {
                    type: 'barchart',
                    settings: { 
        ...
        /////////////////
        {
            ...
            refresh: true,
            searchable: true, // optional search param.. no if undefined
            get: '/api/first_seen/new_ftp_remote/table',
            run: function(data) {
