...
angular.module('mean.pages').controller('iocLocalDrillController', ['$scope', '$stateParams', '$location', 'Global', '$rootScope', '$http', 'timeFormat', 'runPage', 'Crossfilter', function ($scope, $stateParams, $location, Global, $rootScope, $http, timeFormat, runPage, Crossfilter) {
    $scope.global = Global;
    var query;
    ...
    var page = [
        ...
        /////////////////
        {
            ...
            get: '/api/ioc_notifications/ioc_local_drill/crossfilter', // no get default to main url, strings will replace the default (otherwise /[from root])
            visuals: [
                {
                    type: 'barchart',
                    settings: { 
        ...
        /////////////////
        {
            ...
            refresh: true,
            searchable: true, // optional search param.. no if undefined
            get: '/api/ioc_notifications/ioc_local_drill/table',
            run: function(data) {
    ...
    //     query = '/api/ioc_notifications/ioc_local_drill?start='+$location.$$search.start+'&end='+$location.$$search.end+'&lan_zone='+$location.$$search.lan_zone+'&lan_ip='+$location.$$search.lan_ip;
    // } else {
    //     query = '/api/ioc_notifications/ioc_local_drill?&lan_zone='+$location.$$search.lan_zone+'&lan_ip='+$location.$$search.lan_ip;
    // }
