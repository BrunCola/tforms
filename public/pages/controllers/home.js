...
angular.module('mean.pages').controller('tFormHome', ['$scope', '$location', 'Global', '$http', function ($scope, $location, Global, $http) {
    $scope.global = Global;

    // $(window).scrollTop(0);

    $http({method: 'GET', url: "api/home/getClient"}).
    ...
    function editUser (form) {
        if ($scope.userForm.$valid) {
            $http({method: 'POST', url: '/api/home/editClient', data: form })
            .success(function() {
