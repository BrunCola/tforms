...
angular.module('mean.pages').controller('stealthTypeUserController', ['$scope', '$stateParams', '$location', 'Global', '$rootScope', '$http', 'runPage', function ($scope, $stateParams, $location, Global, $rootScope, $http, runPage) {
    $scope.global = Global;
    var query;    
    ...
    var page = [
        ...
        /////////////////
        {
            ...
            get: '/api/stealth/stealth_events_by_type_and_user/table',
            run: function(data) {
