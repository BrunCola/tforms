...
angular.module('mean.pages').controller('stealthFullController', ['$scope', '$stateParams', '$location', 'Global', '$rootScope', '$http', 'runPage', function ($scope, $stateParams, $location, Global, $rootScope, $http, runPage) {
    $scope.global = Global;
    var query;    
    ...
    var page = [
        ...
        /////////////////
        {
            ...
            get: '/api/stealth/stealth_events_full/table',
            run: function(data) {
