...
angular.module('mean.pages').controller('endpointUserIpController', ['$scope', '$stateParams', '$location', 'Global', '$rootScope', '$http', 'runPage', function ($scope, $stateParams, $location, Global, $rootScope, $http, runPage) {
    $scope.global = Global;
    var query;
    ...
    var page = [
        ...
        /////////////////
        {
            ...
            get: '/api/local_events/endpoint_by_user_and_ip/table',
            run: function(data) {
