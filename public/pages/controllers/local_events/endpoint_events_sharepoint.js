...
angular.module('mean.pages').controller('endpointEventsSharepointController', ['$scope', '$stateParams', '$location', 'Global', '$rootScope', '$http', 'timeFormat', 'runPage', 'Crossfilter', function ($scope, $stateParams, $location, Global, $rootScope, $http, timeFormat, runPage, Crossfilter) {
    $scope.global = Global;
    var query;
    ...
    //     query = '/api/local_events/endpoint_events_sharepoint?start='+$location.$$search.start+'&end='+$location.$$search.end;
    // } else {
    //     query = '/api/local_events/endpoint_events_sharepoint?';
    // }
