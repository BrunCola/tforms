...
angular.module('mean.pages').controller('topRemoteIpsController', ['$scope', '$stateParams', '$location', 'Global', '$rootScope', '$http', function ($scope, $stateParams, $location, Global, $rootScope, $http) {
	$scope.global = Global;
	var query;
	if ($location.$$search.start && $location.$$search.end) {
		query = '/general_network/top_remote_ips?start='+$location.$$search.start+'&end='+$location.$$search.end;
	} else {
		query = '/general_network/top_remote_ips?';
	}
