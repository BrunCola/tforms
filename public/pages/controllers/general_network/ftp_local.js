...
angular.module('mean.pages').controller('ftpLocalController', ['$scope', '$stateParams', '$location', 'Global', '$rootScope', '$http', 'runPage', 'Crossfilter', function ($scope, $stateParams, $location, Global, $rootScope, $http, runPage, Crossfilter) {
    $scope.global = Global;
    var query;
    ...
    var page = [
        ...
        /////////////////
        {
            ...
            get: '/api/general_network/ftp_local/table',
            run: function(data) {
    ...
    //     query = '/api/general_network/ftp_local?start='+$location.$$search.start+'&end='+$location.$$search.end;
    // } else {
    //     query = '/api/general_network/ftp_local?';
    // }
