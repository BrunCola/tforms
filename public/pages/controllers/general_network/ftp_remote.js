...
angular.module('mean.pages').controller('ftpRemoteController', ['$scope', '$stateParams', '$location', 'Global', '$rootScope', '$http', 'runPage', 'Crossfilter', function ($scope, $stateParams, $location, Global, $rootScope, $http, runPage, Crossfilter) {
	$scope.global = Global;
	var query;
    ...
    var page = [
        ...
        /////////////////
        {
            ...
            get: '/api/general_network/ftp_remote/table',
            run: function(data) {
