...
angular.module('mean.pages').controller('httpByDomainLocalController', ['$scope', '$stateParams', '$location', 'Global', '$rootScope', '$http', 'runPage', 'Crossfilter', function ($scope, $stateParams, $location, Global, $rootScope, $http, runPage, Crossfilter) {
    $scope.global = Global;
    var query;
    ...
    var page = [
        ...
        /////////////////
        {
            ...
            get: '/api/http/http_by_domain_local/table',
            run: function(data) {
    ...
    if ($location.$$search.start && $location.$$search.end) {
        query = '/api/http/http_by_domain_local?start='+$location.$$search.start+'&end='+$location.$$search.end+'&host='+$location.$$search.host;
    } else {
        query = '/api/http/http_by_domain_local?host='+$location.$$search.host;
    }
