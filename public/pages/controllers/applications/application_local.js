...
angular.module('mean.pages').controller('applicationLocalController', ['$scope', '$stateParams', '$location', 'Global', '$rootScope', '$http', function ($scope, $stateParams, $location, Global, $rootScope, $http) {
	...
	if ($location.$$search.start && $location.$$search.end) {
		query = '/applications/application_local?start='+$location.$$search.start+'&end='+$location.$$search.end+'&lan_ip='+$location.$$search.lan_ip+'&l7_proto='+$location.$$search.l7_proto;
	} else {
		query = '/applications/application_local?lan_ip='+$location.$$search.lan_ip+'&l7_proto='+$location.$$search.l7_proto;
	}
