...
angular.module('mean.pages').controller('smtpSendersController', ['$scope', '$stateParams', '$location', 'Global', '$rootScope', '$http', 'runPage', 'Crossfilter', function ($scope, $stateParams, $location, Global, $rootScope, $http, runPage, Crossfilter) {
    $scope.global = Global;
    var query;
    ...
    var page = [
        ...
        /////////////////
        {
            ...
            get: '/api/email/smtp_senders/table',
            run: function(data) {
    ...
    //     query = '/api/email/smtp_senders?start='+$location.$$search.start+'&end='+$location.$$search.end;
    // } else {
    //     query = '/api/email/smtp_senders?';
    // }
