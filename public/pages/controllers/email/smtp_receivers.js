...
angular.module('mean.pages').controller('smtpReceiversController', ['$scope', '$stateParams', '$location', 'Global', '$rootScope', '$http', 'runPage', 'Crossfilter', function ($scope, $stateParams, $location, Global, $rootScope, $http, runPage, Crossfilter) {
    $scope.global = Global;
    var query;
    ...
    var page = [
        ...
        /////////////////
        {
            ...
            get: '/api/email/smtp_receivers/table',
            run: function(data) {
    ...
    //     query = '/api/email/smtp_receivers?start='+$location.$$search.start+'&end='+$location.$$search.end;
    // } else {
    //     query = '/api/email/smtp_receivers?';
    // }
