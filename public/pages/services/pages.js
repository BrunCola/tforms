			...
			switch(app) {
				...
				case 'ftp_data':
					em
						.append('path')
						.style('fill', '#efa896')
						.attr('d', 'M31.185,10.75H20.405v-0.524c0-1.021-0.821-1.848-1.834-1.848'+
						'h-6.96c-1.012,0-1.835,0.826-1.835,1.848v12.344c0,1.021,0.823,1.848,1.835,1.848h19.574c1.012,0,1.836-0.826,1.836-1.848v-9.973'+
						'C33.021,11.577,32.196,10.75,31.185,10.75z M19.664,13.357l-0.362-1.804c0,0,1.506,2.156,4.23,3.018'+
						'c-2.815,0.477-4.604,2.404-4.604,2.404v-0.001l0.606-1.736c-5.028,0.089-1.957,4.974-0.248,5.83'+
						'C16.118,20.715,10.307,13.44,19.664,13.357z M23.307,21.853l0.101,1.479c0,0-1.153-1.618-3.66-1.968'+
						'c2.779-0.798,4.768-2.684,4.768-2.684l-0.824,1.559c4.857-0.778,2.145-4.851,0.615-5.337C27.308,14.76,32.335,20.474,23.307,21.853z');
					return div;
			}
		}
		return appIcon;
