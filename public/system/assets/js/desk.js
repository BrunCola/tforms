...
(function (window, document, $, undefined) {
    ...
    F.helpers.overlay = {
        ...
        open: function (opts) {
            ...
            else this.create(opts); if (!this.fixed) {
            ...
            return {
                ...
                _buildBaseButton: function () {
                    ...
                    if (this._isChatWidget) {
                        button_text = "Chat with an Agent";
                    ...
                    action_path += "?" + params;
                    if (!show_disabled) {
                        if (this._widgetDisplayMode == 0) result = '<a href="#" class="a-desk-widget a-desk-widget-' + this._type + '" onclick="window.open(\'' + this._base_url + action_path + "', 'assistly_chat','resizable=1, status=0, toolbar=0,width=" + this._widgetPopupWidth + ",height=" + this._widgetPopupHeight + "')\">" + button_text + "</a>";
                        if (this._widgetDisplayMode == 1) result = '<a href="' + this._base_url + action_path + '" class="a-desk-widget a-desk-widget-' + this._type + '">' + button_text + '</a>'
                    } else result = '            <span style="display: none;">&nbsp;</span>';
                    return result
                },
