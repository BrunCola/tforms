// ARCHIVE
angular.module('mean.iochits').controller('archiveController', ['$scope', 'Global', '$http', '$routeParams', '$rootScope', 'socket', '$route', function ($scope, Global, $http, $routeParams, $rootScope, socket, $route) {
	$scope.global = Global;
	$scope.socket = socket;
